...
class JavaGrammarState:
    ...
    def __init__(self,
        ...
        # todo put the method decl on the nonterminal stack
        self._nonterminal_stack = nonterminal_stack
        self._action_indices = action_indices
        # map from nonterminals to potential actions, loaded from file
        self._nonterminal2actions = {}
    ...
    def get_valid_actions(self) -> List[int]:
        ...
        # find the available actions from the last non terminal on the stack
